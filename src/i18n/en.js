...
export default {
  ...
  hud: { level: 'LEVEL {n}', worldMap: 'WORLD MAP', dragonEnergy: 'NOVA ENERGY', tapToStrike: 'TAP A BLOCK TO STRIKE', burnHint: 'TAP A CHARACTER TO USE ITS POWER', todaysBest: "TODAY'S BEST" },
