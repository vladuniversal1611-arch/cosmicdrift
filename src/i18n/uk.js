...
export default {
  ...
  hud: { level: 'РІВЕНЬ {n}', worldMap: 'КАРТА СВІТУ', dragonEnergy: 'ЕНЕРГІЯ НОВИ', tapToStrike: 'ТОРКНИСЬ БЛОКУ', burnHint: 'ТОРКНИСЬ ГЕРОЯ — АКТИВУЙ СИЛУ', todaysBest: 'РЕКОРД ДНЯ' },
  ...
  notif: {
    daily: { title: 'Час грати у Skydoku! 🧩', body: 'Щоденна головоломка й подарунок чекають — очисти кілька ліній!' },
    gift: { title: 'Твій щоденний подарунок готовий! 🎁', body: 'Зазирни й забери безкоштовні монети.' },
    miss: { title: 'Друзі сумують за тобою! 🐸', body: 'Поле чекає — зіграй один раунд.' },
    levels: { title: 'Нові рівні кличуть ✨', body: 'У Skydoku на тебе чекають свіжі головоломки.' },
  },
};
