...
| 📖 Сюжет | 22 розділи з персонажами: радник Тадей, чарівниця Соломія, капітан Орест, кіт Мурко та король гоблінів Ґрукк. Історія викраденого Серця Королівства — від руїн до відродження |
| 👑 Престиж | «Коронація»: скинь королівство заради корон — постійних +2% за кожну |
| 👺 Міні-гра | Напад гоблінів: тапай по гоблінах на карті, лицарі допомагають |
| 🏅 Досягнення | 164 досягнення з нагородами |
...
| 💾 Збереження | Автозбереження кожні 10 сек + при згортанні, експорт/імпорт кодом |
| 🎥 Камера | Щипок — зум, перетягування — панорама |
...
- **Розділ сюжету** → запис у `STORY` (персонаж, текст, умова `cond`, нагорода); нові персонажі — у `CHARS`.
